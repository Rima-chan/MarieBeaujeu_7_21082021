<template>
    <div class="form-group d-flex flex-column my-3">
        ...
        <input type="text" v-model="input" @input="$emit('update:modelValue', $event.target.value)" @keyup="validateInput" class="form-control" id="inputUsername" aria-describedby="Aide pseudo" placeholder="Marie B" minlength="3" maxlength="12" required>
